...
const _saveIdealTree = Symbol('saveIdealTree')
const _registryResolved = Symbol('registryResolved')

// shared symbols for swapping out when testing rollbacks
...
module.exports = cls => class Reifier extends Ideal(cls) {
  ...
  [_saveIdealTree] () {
    ...
    // XXX support save=false option
    //
    // XXX If it was a registry tag or version, save using the savePrefix
    // but maybe that should be handled in the buildIdealTree process?
    //
