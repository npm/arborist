...
module.exports = cls => class IdealTreeBuilder extends cls {
  ...
  async [_inflateAncientLockfile] () {
    ...
    if (!meta.ancientLockfile || inventory.size === 0)
      return
    ...
    this.log.warn('ancient lockfile',
      `
The ${meta.type} file was created with a very old version of npm,
...
`)
    ...
    for (const node of inventory.values()) {
      ...
      await pacote.manifest(id, {
        ...
        this.log.warn('ancient lockfile', warning, er)
      })
