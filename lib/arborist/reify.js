...
const _saveWorkspaceRoot = Symbol('saveWorkspaceRoot')
const _writeWorkspaceRootConfig = Symbol('writeWorkspaceRootConfig')
...
module.exports = cls => class Reifier extends cls {
  constructor (options) {
    ...
    this[_saveWorkspaceRoot] = !!saveWorkspaceRoot
  ...
  async [_writeWorkspaceRootConfig] (node) {
    const rootConfig = relpath(node.realpath, node.root.realpath)
    const file = resolve(node.realpath, '.npmrc')
    await writeFile(file, `workspace-root = ${rootConfig}\n`)
  }
